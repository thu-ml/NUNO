...
class FNO2d(nn.Module):
    def __init__(self, modes1, modes2, width):
        ...
        self.p = nn.Linear(47, self.width) # input channel is 47: the solution of the previous 15 timesteps + 2 locations
        ...
        self.q = MLP(self.width, 3, self.width * 4) # output channel is 3: (x_velocity, y_velocity, pressure)
