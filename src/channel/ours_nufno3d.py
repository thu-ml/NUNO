...
from .interp_fno3d import FNO3d
...
def main(train_a_sd, train_u_sd, test_a_sd, test_u_sd):
    ...
    model = FNO3d(modes, modes, modes, width, 
        in_channels=output_dim*n_subdomains+3, 
    ...
    for ep in range(epochs):
        ...
        for x, y in train_loader:
            ...
            l2 = myloss(out.permute(0, 1, 2, 4, 3), y.permute(0, 1, 2, 4, 3))
            l2.backward()
...
if __name__ == "__main__":
    ...
    if LOAD_PREP:
        ...
        # Mask is used to ignore padded zeros when calculating erros
